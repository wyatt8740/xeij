...
public class FEFunction {
  ...
  //  >d0.l:32bit符号あり整数。積x*y。オーバーフローのときは不定
  //  >ccr:cs=オーバーフロー。C以外は不定
  public static void fpkLMUL () {
    long l = (long) XEiJ.regRn[0] * (long) XEiJ.regRn[1];
    int h = (int) l;
    XEiJ.regRn[0] = h;  //オーバーフローのときは積の下位32bit
  ...
  //  32bit符号あり整数除算
  //  バグ
  //    FLOAT2.X 2.02/2.03は0x00000000/0x00000000がエラーにならない
  //    FLOAT2.X 2.02/2.03は0x80000000/0xffffffff=0x80000000がエラーになる
  //  <d0.l:32bit符号あり整数。被除数x
  //  <d1.l:32bit符号あり整数。除数y
  //  >d0.l:32bit符号あり整数。商x/y。ゼロ除算のときは不定
  //  >ccr:cs=ゼロ除算。C以外は不定
  ...
  //  バグ
  //    FLOAT2.X 2.02/2.03は0x00000000%0x00000000がエラーにならない
  //    FLOAT4.X 1.02は0x80000000%0xffffffff=0x00000000が0xffffffffになる(実機で確認済み)
  //  <d0.l:32bit符号あり整数。被除数x
  //  <d1.l:32bit符号あり整数。除数y
  //  >d0.l:32bit符号あり整数。余りx%y。ゼロ除算のときは不定
  //  >ccr:cs=ゼロ除算。C以外は不定
  ...
  //  >d0.l:32bit符号なし整数。積x*y。オーバーフローのときは不定
  //  >ccr:cs=オーバーフロー。C以外は不定
  public static void fpkUMUL () {
    long l = (0xffffffffL & XEiJ.regRn[0]) * (0xffffffffL & XEiJ.regRn[1]);
    int h = (int) l;
    XEiJ.regRn[0] = h;  //オーバーフローのときは積の下位32bit
  ...
  //  >d0.l:32bit符号なし整数。商x/y。ゼロ除算のときは不定
  //  >ccr:cs=ゼロ除算。C以外は不定
  public static void fpkUDIV () {
    ...
    if (h == 0) {  //ゼロ除算
      ...
      XEiJ.regRn[0] = (int) ((0xffffffffL & XEiJ.regRn[0]) / (0xffffffffL & h));
      XEiJ.regCCR = 0;
    }
  }  //fpkUDIV()
  ...
  //  <d0.l:32bit符号なし整数。被除数x
  //  <d1.l:32bit符号なし整数。除数y
  //  >d0.l:32bit符号なし整数。余りx%y。ゼロ除算のときは不定
  //  >ccr:cs=ゼロ除算。C以外は不定
  ...
  //  <d1.l:32bit符号なし整数。除数y
  //  >d0.l:32bit符号なし整数。商x/y。ゼロ除算のときは不定
  //  >d1.l:32bit符号なし整数。余りx%y。ゼロ除算のときは不定
  //  >ccr:cs=ゼロ除算。C以外は不定
  public static void fpkIDIV () {
    ...
    if (h == 0) {  //ゼロ除算
      ...
      long xl = 0xffffffffL & XEiJ.regRn[0];
      long yl = 0xffffffffL & h;
      long zl = xl / yl;
      XEiJ.regRn[0] = (int) zl;
      XEiJ.regRn[1] = (int) (xl - zl * yl);
      XEiJ.regCCR = 0;
    }
  }  //fpkIDIV()
  ...
  //    FLOAT2.X 2.02/2.03は__LOG(±0)でXEiJ.REG_CCR_CがセットされるがXEiJ.REG_CCR_Zをセットしない
  //  <d0d1.d:64bit浮動小数点数。x
  //  >d0d1.d:64bit浮動小数点数。log(x)
  //  >ccr:0=エラーなし,XEiJ.REG_CCR_C=x<0,XEiJ.REG_CCR_Z|XEiJ.REG_CCR_C=x==0
  ...
  //    FLOAT2.X 2.02/2.03はx<-6243314768165359/274877906944=-22713.0468…のときXEiJ.REG_CCR_Vがセットされない
  //      sinh(0xc0d62e42fefa39ef)はXEiJ.REG_CCR_V|XEiJ.REG_CCR_C
  //      sinh(0xc0d62e42fefa39f0)はXEiJ.REG_CCR_C
  ...
  //  >ccr:0=エラーなし,XEiJ.REG_CCR_C=指数部が範囲外
  ...
  //  >ccr:0=エラーなし,XEiJ.REG_CCR_C=アンダーフロー
  ...
  //  >d1.l:'SOFT'($534F4654)=FLOAT1.X/FLOAT2.X,'FPCP''FPCP'=FLOAT3.X,'FP20'($46503230)=FLOAT4.X
  ...
  //  >ccr:0=エラーなし,XEiJ.REG_CCR_N|XEiJ.REG_CCR_C=文法エラー,XEiJ.REG_CCR_V|XEiJ.REG_CCR_C=オーバーフロー
  ...
  public static void fpkDTOSSub (long l) throws M68kException {
    ...
    if (0 <= e && e < len3) {  //1<=x<10^len3。指数形式にしない
      do {
        XEiJ.busWb (a++, '0' + w[h++]);  //整数部。末尾の位置に関係なく1の位まで書く
      } while (0 <= --e);
      if (h < o) {  //小数部がある
  ...
  //  >ccr:0=エラーなし,XEiJ.REG_CCR_C=アンダーフロー,XEiJ.REG_CCR_V|XEiJ.REG_CCR_C=オーバーフロー
