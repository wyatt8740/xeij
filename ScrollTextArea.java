...
public class ScrollTextArea extends JScrollPane {
  ...
  public ScrollTextArea () {
    ...
    foregroundColor      = new Color (LnF.LNF_RGB[14]);
    backgroundColor      = new Color (LnF.LNF_RGB[0]);
    rowGridColor         = new Color (LnF.LNF_RGB[2]);
    columnGridColor      = new Color (LnF.LNF_RGB[1]);
    tabColumnGridColor   = new Color (LnF.LNF_RGB[2]);
    highlightAreaColor   = new Color (LnF.LNF_RGB[3]);
    highlightCursorColor = new Color (LnF.LNF_RGB[4]);
    underlineCursorColor = new Color (LnF.LNF_RGB[10]);
    ...
    textArea = new JTextArea () {
      ...
      @Override public void paintComponent (Graphics g) {
        ...
        if (0 <= highlightAreaEnd) {
          try {
            Rectangle startRect = modelToView (highlightAreaStart);
            Rectangle endRect = modelToView (highlightAreaEnd);
    ...
    textArea.setSelectionColor (new Color (LnF.LNF_RGB[7]));  //選択領域の背景の色
    //textArea.setSelectedTextColor (new Color (LnF.LNF_RGB[14]));  //選択領域のテキストの色
