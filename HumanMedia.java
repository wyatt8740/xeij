...
public class HumanMedia {
  ...
  public boolean humCopyHumanSys (byte[] bb) {
    ...
    byte[] rr = XEiJ.ismGetResource ("HUMAN.SYS");
  ...
  public boolean humCopyCommandX (byte[] bb) {
    ...
    byte[] rr = XEiJ.ismGetResource ("COMMAND.X");
