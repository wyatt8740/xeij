...
public class DecimalSpinner extends NumberSpinner {
  ...
  public DecimalSpinner (int value, int minimum, int maximum, int stepSize, int option) {
    ...
    this.option = option;
    this.setBorder (new LineBorder (new Color (LnF.LNF_RGB[10]), 1));
    int digits = ((32 - Integer.numberOfLeadingZeros (maximum)) * 77 >> 8) + 1;  //maximumの桁数
    XEiJ.setFixedSize (this, 24 + 8 * digits, 16);
  ...
  public void setIntValue (int value) {
    ...
    this.model.setValue (new Integer (value));
