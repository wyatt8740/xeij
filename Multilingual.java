...
public class Multilingual {
  ...
  public static void mlnInit () {
    ...
    //現在の言語
    mlnLang = "";
    mlnChange (XEiJ.prgLang);  //mlnLangとmlnEnglishなどを設定させる
  }  //mlnInit()
  ...
  public static void mlnChange (String lang) {
    if (!mlnLang.equals (lang)) {  //現在の言語と異なるとき
      //現在の言語
      mlnLang = lang;
      mlnEnglish = mlnLang.equals ("en");
      mlnJapanese = mlnLang.equals ("ja");
      //ボタンのテキストの言語を切り替える
      ...
      XEiJ.prgMessage (mlnJapanese ? "日本語が選択されました" : "English has been selected");
    }
  }  //mlnChange(String)
