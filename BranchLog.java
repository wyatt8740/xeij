...
public class BranchLog {
  ...
  public static final String BLG_CLEAR_PATTERN = (
  ...
  public static final String BLG_OLDEST_RECORD_PATTERN = (
    "11111111111111111111" +
    "1..................1" +
    "1.1111....11....11.1" +
    "1.1..1...1.1...1.1.1" +
  ...
  public static final String BLG_PREVIOUS_PAGE_PATTERN = (
    "11111111111111111111" +
    "1..................1" +
    "1.......11....11...1" +
    "1......1.1...1.1...1" +
  ...
  public static final String BLG_PREVIOUS_RECORD_PATTERN = (
    "11111111111111111111" +
    "1..................1" +
    "1..........11......1" +
    "1.........1.1......1" +
  ...
  public static final String BLG_NEXT_RECORD_PATTERN = (
    "11111111111111111111" +
    "1..................1" +
    "1......11..........1" +
    "1......1.1.........1" +
  ...
  public static final String BLG_NEXT_PAGE_PATTERN = (
    "11111111111111111111" +
    "1..................1" +
    "1...11....11.......1" +
    "1...1.1...1.1......1" +
  ...
  public static final String BLG_NEWEST_RECORD_PATTERN = (
    "11111111111111111111" +
    "1..................1" +
    "1.11....11....1111.1" +
    "1.1.1...1.1...1..1.1" +
  ...
  public static void blgMakeFrame () {
    ...
    //スクロールテキストエリア
    blgScrollTextArea = XEiJ.setPreferredSize (
              ...
              if (blgSelectedItem != item) {  //選択されているレコードとは別の項目に移動した
                if (item == 0) {  //先頭の番兵
                  ...
                  if (blgModel.getNumber ().longValue () != record) {
                    blgModel.setValue (new Long (record));  //スピナーの値を設定する
                  }
                  blgLock = false;
                } else {  //末尾の番兵
    ...
    blgSpinner = XEiJ.createNumberSpinner (blgModel, 15, new ChangeListener () {
        ...
        XEiJ.createBorderPanel (
          ...
          XEiJ.createHorizontalBox (
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_CLEAR_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_CLEAR_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
                  "Clear", listener),
                "ja", "クリア")
              ),
            ...
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_OLDEST_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_OLDEST_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
            ...
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_PREVIOUS_PAGE_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_PREVIOUS_PAGE_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
            ...
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_PREVIOUS_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_PREVIOUS_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
            ...
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_NEXT_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_NEXT_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
            ...
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_NEXT_PAGE_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_NEXT_PAGE_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
                  "Next Page", listener),
                "ja", "次のページ")
              ),
            XEiJ.mpuAddButtonStopped (
              Multilingual.mlnToolTipText (
                XEiJ.createImageButton (
                  XEiJ.createImage (20, 14, BLG_NEWEST_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[12]),
                  XEiJ.createImage (20, 14, BLG_NEWEST_RECORD_PATTERN, LnF.LNF_RGB[0], LnF.LNF_RGB[6]),
  ...
  public static void blgUpdate (long selectedRecord) {
    ...
    if (blgModel.getNumber ().longValue () != selectedRecord) {
      blgModel.setValue (new Long (selectedRecord));  //スピナーの値を設定する。ロックしてあるのでイベントで更新がネストすることはない
    }
