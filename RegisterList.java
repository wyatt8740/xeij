...
public class RegisterList {
  ...
  public static void drpMake () {
    ...
    //スクロールテキストエリア
    drpBoard = XEiJ.setPreferredSize (
    ...
    ActionListener listener = new ActionListener () {
      @Override public void actionPerformed (ActionEvent ae) {
        ...
        case "Consider the opcode $0000 (ORI.B #$00,D0) as an illegal instruction" :
          if (XEiJ.DBG_ORI_BYTE_ZERO_D0) {
            XEiJ.dbgOriByteZeroD0 = ((JCheckBox) source).isSelected ();
          }
          break;
        case "Stop on Error":
          XEiJ.dbgStopOnError = ((JCheckBox) source).isSelected ();
          break;
        }
      }
    };
            ...
            XEiJ.createFlowPanel (
              ...
              Multilingual.mlnToolTipText (
                XEiJ.createIconCheckBox (
                  XEiJ.DBG_ORI_BYTE_ZERO_D0 ? XEiJ.dbgOriByteZeroD0 : null,
                  XEiJ.createImage (
                    20, 14,
                  ...
                  XEiJ.createImage (
                    ...
                    LnF.LNF_RGB[12],
                    LnF.LNF_RGB[12]),
                  "Consider the opcode $0000 (ORI.B #$00,D0) as an illegal instruction", listener),
                "ja", "オペコード $0000 (ORI.B #$00,D0) を不当命令とみなす"),
              Multilingual.mlnToolTipText (
                XEiJ.createIconCheckBox (
                  XEiJ.dbgStopOnError, 
                  XEiJ.createImage (
  ...
  public static void drpSetMPU () {
    drpCurrentBase = (XEiJ.mpuCoreType == 0 ? DRP_BASE_000 :
                      XEiJ.mpuCoreType == 3 ? DRP_BASE_030 :
                      DRP_BASE_060);
    if (drpTextArea != null) {
