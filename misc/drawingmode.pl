...
//========================================================================================
//  DrawingMode.java
//    en:Drawing mode -- It superimposes a raster of the sprite screen, the text screen and the graphics screen according to the drawing mode.
//    ja:描画モード -- 描画モードに従って1ラスタ分のスプライト画面、テキスト画面およびグラフィックス画面を重ね合わせます。
//  Copyright (C) 2003-2016 Makoto Kamada
//
//  This file is part of the XEiJ (X68000 Emulator in Java).
//  You can use, modify and redistribute the XEiJ if the conditions are met.
...
#
#  ● G グラフィックス
#       ← sG スプライト(OFF)＞グラフィックス
#       ← tG テキスト(OFF)＞グラフィックス
#       ← stG スプライト(OFF)＞テキスト(OFF)＞グラフィックス
#       ← tsG テキスト(OFF)＞スプライト(OFF)＞グラフィックス
#
#  ● GS グラフィックス＞スプライト
#       ← GSt グラフィックス＞スプライト＞テキスト(OFF)
#       ← GtS グラフィックス＞テキスト(OFF)＞スプライト
#       ← tGS テキスト(OFF)＞グラフィックス＞スプライト
#
#     Gs グラフィックス＞スプライト(OFF) → Gt グラフィックス＞テキスト(OFF)
#
#  ● SG スプライト＞グラフィックス
#       ← StG スプライト＞テキスト(OFF)＞グラフィックス
#       ← tSG テキスト(OFF)＞スプライト＞グラフィックス
#
#     sG スプライト(OFF)＞グラフィックス → G グラフィックス
#
#  ● GT グラフィックス＞テキスト
#       ← GTs グラフィックス＞テキスト＞スプライト(OFF)
#       ← GsT グラフィックス＞スプライト(OFF)＞テキスト
#       ← sGT スプライト(OFF)＞グラフィックス＞テキスト
#
#  ● Gt グラフィックス＞テキスト(OFF)
#       ← Gs グラフィックス＞スプライト(OFF)
#       ← Gst グラフィックス＞スプライト(OFF)＞テキスト(OFF)
#       ← sGt スプライト(OFF)＞グラフィックス＞テキスト(OFF)
#       ← Gts グラフィックス＞テキスト(OFF)＞スプライト(OFF)
#       ← tGs テキスト(OFF)＞グラフィックス＞スプライト(OFF)
#
#  ● TG テキスト＞グラフィックス
#       ← sTG スプライト(OFF)＞テキスト＞グラフィックス
#       ← TsG テキスト＞スプライト(OFF)＞グラフィックス
#
#     tG テキスト(OFF)＞グラフィックス → G グラフィックス
#
#  ● GST グラフィックス＞スプライト＞テキスト
#
#     GSt グラフィックス＞スプライト＞テキスト(OFF) → GS グラフィックス＞スプライト
#
#     GsT グラフィックス＞スプライト(OFF)＞テキスト → GT グラフィックス＞テキスト
#
#     Gst グラフィックス＞スプライト(OFF)＞テキスト(OFF) → Gt グラフィックス＞テキスト(OFF)
#
#  ● SGT スプライト＞グラフィックス＞テキスト
#
#  ● SGt スプライト＞グラフィックス＞テキスト(OFF)
#
#     sGT スプライト(OFF)＞グラフィックス＞テキスト → GT グラフィックス＞テキスト
#
#     sGt スプライト(OFF)＞グラフィックス＞テキスト(OFF) → Gt グラフィックス＞テキスト(OFF)
#
#  ● STG スプライト＞テキスト＞グラフィックス
#
#     StG スプライト＞テキスト(OFF)＞グラフィックス → SG スプライト＞グラフィックス
#
#     sTG スプライト(OFF)＞テキスト＞グラフィックス → TG テキスト＞グラフィックス
#
#     stG スプライト(OFF)＞テキスト(OFF)＞グラフィックス → G グラフィックス
#
#  ● GTS グラフィックス＞テキスト＞スプライト
#
#     GTs グラフィックス＞テキスト＞スプライト(OFF) → GT グラフィックス＞テキスト
#
#     GtS グラフィックス＞テキスト(OFF)＞スプライト → GS グラフィックス＞スプライト
# 
#     Gts グラフィックス＞テキスト(OFF)＞スプライト(OFF) → Gt グラフィックス＞テキスト(OFF)
#
#  ● TGS テキスト＞グラフィックス＞スプライト
#
#  ● TGs テキスト＞グラフィックス＞スプライト(OFF)
#
#     tGS テキスト(OFF)＞グラフィックス＞スプライト → GS グラフィックス＞スプライト
#
#     tGs テキスト(OFF)＞グラフィックス＞スプライト(OFF) → Gt グラフィックス＞テキスト(OFF)
#
#  ● TSG テキスト＞スプライト＞グラフィックス
#
#     TsG テキスト＞スプライト(OFF)＞グラフィックス → TG テキスト＞グラフィックス
#
#     tSG テキスト(OFF)＞スプライト＞グラフィックス → SG スプライト＞グラフィックス
#
#     tsG テキスト(OFF)＞スプライト(OFF)＞グラフィックス → G グラフィックス
#
my @KEYWORD = (
  map {
...
my %X_TEXT = (
  ...
  #A  テキストパレット0と半透明
  A => 'グラフィックスカラーとテキストパレット0のカラーを混ぜる'
  );
...
sub pass1 {
  ...
  if ($xword eq 'A') {  #グラフィックスカラーとテキストパレット0のカラーを混ぜる
    if ($keyword =~ /(?:E1|F1|G|H|I|J)/) {  #グラフィックス1プレーン。1番目はON、2番目と3番目と4番目はOFF
      push @out, $encode ? ($dp ?
                            "mix(${pt}pc(${pt}1p(),${pt}1p()),tpc(0))" :
                            "mix(${pt}pc(${pt}1p()),tpc(0))") : "${indent}1番目のカラーとテキストパレット0のカラーを混ぜたカラー(0は黒)\n";
    } elsif ($keyword =~ /(?:E2|F2)/) {  #グラフィックス2プレーン。2番目はON、3番目と4番目はOFF。1番目はOFFのときパレット0とみなす
      push @out, $encode ? "(" : "";
      ...
      push @out, $encode ? ")" : "";
    } elsif ($keyword =~ /(?:E3)/) {  #グラフィックス3プレーン。3番目はON、4番目はOFF。1番目と2番目はOFFのときパレット0とみなす
      push @out, $encode ? "(" : "";
      push @out, $encode ? "${pt}1p()!=0" : "${indent}1番目のパレットが0でないとき\n";
      push @out, $encode ? "?" : "";
      push @out, $encode ? ($dp ?
      ...
      push @out, $encode ? ")" : "";
      push @out, $encode ? ")" : "";
    } elsif ($keyword =~ /(?:E4)/) {  #グラフィックス4プレーン。4番目はON。1番目と2番目と3番目はOFFのときパレット0とみなす
      push @out, $encode ? "(" : "";
      push @out, $encode ? "${pt}1p()!=0" : "${indent}1番目のパレットが0でないとき\n";
      push @out, $encode ? "?" : "";
      push @out, $encode ? ($dp ?
      ...
      push @out, $encode ? "0" : "${indent}カラー0(黒)\n";  #グラフィックスがOFFのときは表示なし。テキストパレット0が黒でなくても黒になる
    }
    return @out;
  }

  if ($keyword =~ /(?:E1|E2|E3|E4|F1|F2|G|H|I|J)/) {  #グラフィックスが1プレーン以上ある
    my $ahead = $`;  #グラフィックスの手前にある画面
    my $g = $&;  #グラフィックス
    my $behind = $';  #グラフィックスの奥にある画面

    if ($xword eq 'XWC') {  #優先順位に関わらず0でない1番目のパレットを偶数化(65536色は奇数化)したパレットのカラーが奇数のとき0でない1番目のパレットのカラーだけ表示する
      $mode->{'xword'} = '';
      if ($ahead eq '' && $behind eq '') {  #グラフィックスのみ
        ...
        push @out, $encode ? ")" : "";
      } elsif ($g =~ /(?:E1|F1|H|I)/) {  #グラフィックス1プレーン。1番目はON、2番目と3番目と4番目はOFF
        push @out, $encode ? "(" : "";
        push @out, $encode ? ($dp ?
        ...
        push @out, pass1 ("${indent}  ", $keyword, $mode);
        push @out, $encode ? ")" : "";
      } elsif ($g =~ /(?:E2|F2)/) {  #グラフィックス2プレーン。2番目はON、3番目と4番目はOFF。1番目はOFFのときパレット0とみなす
        push @out, $encode ? "(" : "";
        push @out, $encode ? "${pt}1p()!=0" : "${indent}1番目のパレットが0でないとき\n";
        push @out, $encode ? "?" : "";
        $mode->{'nonzero1st'}++;
        ...
        $mode->{'zero1st'}--;
        push @out, $encode ? ")" : "";
      } elsif ($g =~ /(?:E3)/) {  #グラフィックス3プレーン。3番目はON、4番目はOFF。1番目と2番目はOFFのときパレット0とみなす
        push @out, $encode ? "(" : "";
        push @out, $encode ? "${pt}1p()!=0" : "${indent}1番目のパレットが0でないとき\n";
        push @out, $encode ? "?" : "";
        $mode->{'nonzero1st'}++;
        ...
        $mode->{'zero1st'}--;
        push @out, $encode ? ")" : "";
      } elsif ($g =~ /(?:E4)/) {  #グラフィックス4プレーン。4番目はON。1番目と2番目と3番目はOFFのときパレット0とみなす
        push @out, $encode ? "(" : "";
        push @out, $encode ? "${pt}1p()!=0" : "${indent}1番目のパレットが0でないとき\n";
        push @out, $encode ? "?" : "";
        $mode->{'nonzero1st'}++;
    ...
    if ($ahead eq '') {  #今回がグラフィックス
      ...
      if ($xword eq 'XHCG') {  #0でない1番目のパレットを偶数化したパレットのカラーが奇数のときそれと2番目のパレットを奇数化したパレットのカラーを混ぜる
        $mode->{'xword'} = '';
        if ($g =~ /(?:E1|F1|G|H|I|J)/) {  #グラフィックス1プレーン。1番目はON、2番目と3番目と4番目はOFF
          {
            push @out, $encode ? "(" : "";
            push @out, $encode ? ($dp ?
                                  "ls1(${pt}pc(tev(${pt}1p()),tev(${pt}1p())))!=0" :
  ...
  if ($keyword =~ /^(?:E1|F1|G|H|I|J)/) {  #グラフィックス1プレーン。1番目はON、2番目と3番目と4番目はOFF
    ...
    my $color1st = (($mode->{'zero1st'} && !$mode->{'toodd'}) ||
                    ($mode->{'one1st'} && $mode->{'toeven'}) ? $encode ? ($dp ?
                                                                          "${pt}pc(0,0)" :
                                                                          "${pt}pc(0)") : 'グラフィックスパレット0のカラー' :
                    ($mode->{'zero1st'} && $mode->{'toodd'}) ||
                    ($mode->{'one1st'} && !$mode->{'toeven'}) ? $encode ? ($dp ?
                                                                           "${pt}pc(1,1)" :
                                                                           "${pt}pc(1)") : 'グラフィックスパレット1のカラー' :
  ...
  if ($keyword =~ /^(?:E2|F2)/) {  #グラフィックス2プレーン。2番目はON、3番目と4番目はOFF。1番目はOFFのときパレット0とみなす
    my $behind = $';
    my $palet1st = (($mode->{'zero1st'} && !$mode->{'toodd'}) ||
                    ($mode->{'one1st'} && $mode->{'toeven'}) ? $encode ? "0" : 'グラフィックスパレット0' :
                    ($mode->{'zero1st'} && $mode->{'toodd'}) ||
                    ($mode->{'one1st'} && !$mode->{'toeven'}) ? $encode ? "1" : 'グラフィックスパレット1' :
  ...
  if ($keyword =~ /^E3/) {  #グラフィックス3プレーン。3番目はON、4番目はOFF。1番目と2番目はOFFのときパレット0とみなす
    my $behind = $';
    my $palet1st = (($mode->{'zero1st'} && !$mode->{'toodd'}) ||
                    ($mode->{'one1st'} && $mode->{'toeven'}) ? $encode ? "0" : 'グラフィックスパレット0' :
                    ($mode->{'zero1st'} && $mode->{'toodd'}) ||
    ...
    my $palet2nd = (($mode->{'zero2nd'} && !$mode->{'toodd'}) ||
                    ($mode->{'one2nd'} && $mode->{'toeven'}) ? $encode ? "0" : 'グラフィックスパレット0' :
                    ($mode->{'zero2nd'} && $mode->{'toodd'}) ||
                    ($mode->{'one2nd'} && !$mode->{'toeven'}) ? $encode ? "1" : 'グラフィックスパレット1' :
  ...
  if ($keyword =~ /^E4/) {  #グラフィックス4プレーン。4番目はON。1番目と2番目と3番目はOFFのときパレット0とみなす
    my $behind = $';
    my $palet1st = (($mode->{'zero1st'} && !$mode->{'toodd'}) ||
                    ($mode->{'one1st'} && $mode->{'toeven'}) ? $encode ? "0" : 'グラフィックスパレット0' :
                    ($mode->{'zero1st'} && $mode->{'toodd'}) ||
    ...
    my $palet3rd = (($mode->{'zero3rd'} && !$mode->{'toodd'}) ||
                    ($mode->{'one3rd'} && $mode->{'toeven'}) ? $encode ? "0" : 'グラフィックスパレット0' :
                    ($mode->{'zero3rd'} && $mode->{'toodd'}) ||
                    ($mode->{'one3rd'} && !$mode->{'toeven'}) ? $encode ? "1" : 'グラフィックスパレット1' :
...
sub function_evaluate {
  ...
  if ($name eq 'e1p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    return new_arrayaccess (new_id ('MainMemory.mmrM8'),
  ...
  #if ($name eq 'f1p') {
  #  @$children == 1 or die "wrong length of parameter list of $name";
  #  return new_bitwiseior (new_shiftleft (new_arrayaccess (new_bitwiseior (new_id ('gy2nd'),
  #                                                                         new_bitwiseand ($k == 0 ?
  #                                                                                         new_id ('gx2nd') :
  #                                                                                         new_addition (new_id ('gx2nd'),
  #                                                                                                       new_id (2 * $k)),
  #                                                                                         new_int (1023)))),
  #                                        new_int (4)),
  #                         new_arrayaccess (new_bitwiseior (new_id ('gy1st'),
  #                                                          new_bitwiseand ($k == 0 ?
  #                                                                          new_id ('gx1st') :
  #                                                                          new_addition (new_id ('gx1st'),
  #                                                                                        new_id (2 * $k)),
  ...
  #if ($name eq 'f2p') {
  #  @$children == 1 or die "wrong length of parameter list of $name";
  #  return new_bitwiseior (new_shiftleft (new_arrayaccess (new_bitwiseior (new_id ('gy4th'),
  #                                                                         new_bitwiseand ($k == 0 ?
  #                                                                                         new_id ('gx4th') :
  #                                                                                         new_addition (new_id ('gx4th'),
  #                                                                                                       new_id (2 * $k)),
  #                                                                                         new_int (1023)))),
  #                                        new_int (4)),
  #                         new_arrayaccess (new_bitwiseior (new_id ('gy3rd'),
  #                                                          new_bitwiseand ($k == 0 ?
  #                                                                          new_id ('gx3rd') :
  #                                                                          new_addition (new_id ('gx3rd'),
  #                                                                                        new_id (2 * $k)),
  ...
  #if ($name eq 'f2q') {
  #  @$children == 1 or die "wrong length of parameter list of $name";
  #  return new_bitwiseior (new_shiftleft (new_arrayaccess (new_bitwiseior (new_id ('gz4th'),
  #                                                                         new_bitwiseand ($k == 0 ?
  #                                                                                         new_id ('gx4th') :
  #                                                                                         new_addition (new_id ('gx4th'),
  #                                                                                                       new_id (2 * $k)),
  #                                                                                         new_int (1023)))),
  #                                        new_int (4)),
  #                         new_arrayaccess (new_bitwiseior (new_id ('gz3rd'),
  #                                                          new_bitwiseand ($k == 0 ?
  #                                                                          new_id ('gx3rd') :
  #                                                                          new_addition (new_id ('gx3rd'),
  #                                                                                        new_id (2 * $k)),
  ...
  #if ($name eq 'g1p') {
  #  @$children == 1 or die "wrong length of parameter list of $name";
  #  return new_bitwiseior (new_bitwiseior (new_bitwiseior (new_shiftleft (new_arrayaccess (new_bitwiseior (new_id ('gy4th'),
  #                                                                                                         new_bitwiseand ($k == 0 ?
  #                                                                                                                         new_id ('gx4th') :
  #                                                                                                                         new_addition (new_id ('gx4th'),
  #                                                                                                                                       new_id (2 * $k)),
  #                                                                                                                         new_int (1023)))),
  #                                                                        new_int (12)),
  #                                                         new_shiftleft (new_arrayaccess (new_bitwiseior (new_id ('gy3rd'),
  #                                                                                                         new_bitwiseand ($k == 0 ?
  #                                                                                                                         new_id ('gx3rd') :
  #                                                                                                                         new_addition (new_id ('gx3rd'),
  #                                                                                                                                       new_id (2 * $k)),
  #                                                                                                                         new_int (1023)))),
  #                                                                        new_int (8))),
  #                                         new_shiftleft (new_arrayaccess (new_bitwiseior (new_id ('gy2nd'),
  #                                                                                         new_bitwiseand ($k == 0 ?
  #                                                                                                         new_id ('gx2nd') :
  #                                                                                                         new_addition (new_id ('gx2nd'),
  #                                                                                                                       new_id (2 * $k)),
  ...
  if ($name eq 'h1p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    return new_arrayaccess (new_id ('MainMemory.mmrM8'),
                            $k == 0 ? new_id ('ga') : new_addition (new_id ('ga'),
                                                                    new_int (2 * $k)));
  }
  if ($name eq 'i1p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    return new_bitwiseand (new_arrayaccess (new_id ('MainMemory.mmrM8'),
                                            $k == 0 ? new_id ('ga') : new_addition (new_id ('ga'),
                                                                                    new_int (2 * $k))),
                           new_int (255));
  }
  #if ($name eq 'j1p') {
  #  @$children == 1 or die "wrong length of parameter list of $name";
  #  return new_castchar (new_bitwiseior (new_shiftleft (new_arrayaccess (new_id ('MainMemory.mmrM8'),
  #                                                                       $k == 0 ?
  #                                                                       new_id ('ga') :
  #                                                                       new_addition (new_id ('ga'),
  #                                                                                     new_int (2 * $k))),
  #                                                      new_int (8)),
  #                                       new_bitwiseand (new_arrayaccess (new_id ('MainMemory.mmrM8'),
  #                                                                        new_addition (new_id ('ga'),
  #                                                                                      new_int (2 * $k + 1))),
  #                                                       new_int (255))));
  #}
...
sub function_tocode {
  ...
  if ($name eq 'cto') {
    ...
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("MainMemory.mmrM8[gy1st | gx1st$p2k & 1023]", $status);
  } elsif ($name eq 'e2p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("MainMemory.mmrM8[gy2nd | gx2nd$p2k & 1023]", $status);
  } elsif ($name eq 'e2q') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("MainMemory.mmrM8[gz2nd | gx2nd$p2k & 1023]", $status);
  } elsif ($name eq 'e3p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("MainMemory.mmrM8[gy3rd | gx3rd$p2k & 1023]", $status);
  } elsif ($name eq 'e4p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("MainMemory.mmrM8[gy4th | gx4th$p2k & 1023]", $status);
  } elsif ($name eq 'epc' ||
           $name eq 'fpc' ||
           $name eq 'hpc' ||
           $name eq 'ipc') {
    ...
    @$children == 1 or die "wrong length of parameter list of $name";
    put_left ('(', $status);
    put_newline ("MainMemory.mmrM8[gy2nd | gx2nd$p2k & 1023] << 4 |\n", $status);
    put_right ("MainMemory.mmrM8[gy1st | gx1st$p2k & 1023])", $status);
  } elsif ($name eq 'f2p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_left ('(', $status);
    put_newline ("MainMemory.mmrM8[gy4th | gx4th$p2k & 1023] << 4 |\n", $status);
    put_right ("MainMemory.mmrM8[gy3rd | gx3rd$p2k & 1023])", $status);
  } elsif ($name eq 'f2q') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_left ('(', $status);
    put_newline ("MainMemory.mmrM8[gz4th | gx4th$p2k & 1023] << 4 |\n", $status);
    put_right ("MainMemory.mmrM8[gz3rd | gx3rd$p2k & 1023])", $status);
  } elsif ($name eq 'g1p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_left ('(', $status);
    put_newline ("MainMemory.mmrM8[gy4th | gx4th$p2k & 1023] << 12 |\n", $status);
    put_newline ("MainMemory.mmrM8[gy3rd | gx3rd$p2k & 1023] << 8 |\n", $status);
    put_newline ("MainMemory.mmrM8[gy2nd | gx2nd$p2k & 1023] << 4 |\n", $status);
    put_right ("MainMemory.mmrM8[gy1st | gx1st$p2k & 1023])", $status);
  } elsif ($name eq 'gpc' ||
           $name eq 'jpc') {
    ...
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("MainMemory.mmrM8[ga$p2k]", $status);
  } elsif ($name eq 'i1p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_text ("(MainMemory.mmrM8[ga$p2k] & 255)", $status);
  } elsif ($name eq 'j1p') {
    @$children == 1 or die "wrong length of parameter list of $name";
    put_left ('(char) (', $status);
    put_newline ("MainMemory.mmrM8[ga$p2k] << 8 |\n", $status);
    put_right ("MainMemory.mmrM8[ga$p2k1] & 255)", $status);
  } else {
    die $name;
  }
}
...
#    テキスト構造
#      (準備)
#      int tc = CRTC.crtR10TxXCurr >> 3;  //テキスト桁位置
#      int ta0 = 0x00e00000 + ((CRTC.crtR11TxYCurr + src & 1023) << 7);  //桁0のテキストアドレス
...
#      int gx1st = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy1st = VideoController.vcnVisible1st + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      (e2p()またはe2q()があるとき)
#      pn = VideoController.vcnReg2Curr >> 2 & 3;  //2番目のパレットのGVRAMページ番号
#      int gx2nd = CRTC.crtR12GrXCurr[pn] << 1;
#      (e2p()があるとき)
#      int gy2nd = VideoController.vcnVisible2nd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      (e2q()があるとき)
#      int gz2nd = VideoController.vcnHidden2nd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);  //ONとみなす
#      (e3p()があるとき)
#      pn = VideoController.vcnReg2Curr >> 4 & 3;  //3番目のパレットのGVRAMページ番号
#      int gx3rd = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy3rd = VideoController.vcnVisible3rd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      (e4p()があるとき)
#      pn = VideoController.vcnReg2Curr >> 6 & 3;  //4番目のパレットのGVRAMページ番号
#      int gx4th = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy4th = VideoController.vcnVisible4th + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#    512ドット16色パレット e1p()
#      k=0  MainMemory.mmrM8[gy1st | gx1st & 1023]
#      k=1  MainMemory.mmrM8[gy1st | gx1st + 2 & 1023]
#      k=2  MainMemory.mmrM8[gy1st | gx1st + 4 & 1023]
#      k=3  MainMemory.mmrM8[gy1st | gx1st + 6 & 1023]
#      k=4  MainMemory.mmrM8[gy1st | gx1st + 8 & 1023]
#      k=5  MainMemory.mmrM8[gy1st | gx1st + 10 & 1023]
#      k=6  MainMemory.mmrM8[gy1st | gx1st + 12 & 1023]
#      k=7  MainMemory.mmrM8[gy1st | gx1st + 14 & 1023]
#    512ドット16色パレット e2p()
#      k=0  MainMemory.mmrM8[gy2nd | gx2nd & 1023]
#      k=1  MainMemory.mmrM8[gy2nd | gx2nd + 2 & 1023]
#      k=2  MainMemory.mmrM8[gy2nd | gx2nd + 4 & 1023]
#      k=3  MainMemory.mmrM8[gy2nd | gx2nd + 6 & 1023]
#      k=4  MainMemory.mmrM8[gy2nd | gx2nd + 8 & 1023]
#      k=5  MainMemory.mmrM8[gy2nd | gx2nd + 10 & 1023]
#      k=6  MainMemory.mmrM8[gy2nd | gx2nd + 12 & 1023]
#      k=7  MainMemory.mmrM8[gy2nd | gx2nd + 14 & 1023]
#    512ドット16色パレット(ONとみなす) e2q()
#      k=0  MainMemory.mmrM8[gz2nd | gx2nd & 1023]
#      k=1  MainMemory.mmrM8[gz2nd | gx2nd + 2 & 1023]
#      k=2  MainMemory.mmrM8[gz2nd | gx2nd + 4 & 1023]
#      k=3  MainMemory.mmrM8[gz2nd | gx2nd + 6 & 1023]
#      k=4  MainMemory.mmrM8[gz2nd | gx2nd + 8 & 1023]
#      k=5  MainMemory.mmrM8[gz2nd | gx2nd + 10 & 1023]
#      k=6  MainMemory.mmrM8[gz2nd | gx2nd + 12 & 1023]
#      k=7  MainMemory.mmrM8[gz2nd | gx2nd + 14 & 1023]
#    512ドット16色パレット e3p()
#      k=0  MainMemory.mmrM8[gy3rd | gx3rd & 1023]
#      k=1  MainMemory.mmrM8[gy3rd | gx3rd + 2 & 1023]
#      k=2  MainMemory.mmrM8[gy3rd | gx3rd + 4 & 1023]
#      k=3  MainMemory.mmrM8[gy3rd | gx3rd + 6 & 1023]
#      k=4  MainMemory.mmrM8[gy3rd | gx3rd + 8 & 1023]
#      k=5  MainMemory.mmrM8[gy3rd | gx3rd + 10 & 1023]
#      k=6  MainMemory.mmrM8[gy3rd | gx3rd + 12 & 1023]
#      k=7  MainMemory.mmrM8[gy3rd | gx3rd + 14 & 1023]
#    512ドット16色パレット e4p()
#      k=0  MainMemory.mmrM8[gy4th | gx4th & 1023]
#      k=1  MainMemory.mmrM8[gy4th | gx4th + 2 & 1023]
#      k=2  MainMemory.mmrM8[gy4th | gx4th + 4 & 1023]
#      k=3  MainMemory.mmrM8[gy4th | gx4th + 6 & 1023]
#      k=4  MainMemory.mmrM8[gy4th | gx4th + 8 & 1023]
#      k=5  MainMemory.mmrM8[gy4th | gx4th + 10 & 1023]
#      k=6  MainMemory.mmrM8[gy4th | gx4th + 12 & 1023]
#      k=7  MainMemory.mmrM8[gy4th | gx4th + 14 & 1023]
#    512ドット16色カラー epc(p)
...
#      int gy3rd = VideoController.vcnVisible3rd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      (f2q()があるとき)
#      int gz3rd = VideoController.vcnHidden3rd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      (f2p()またはf2q()があるとき)
...
#      int gy4th = VideoController.vcnVisible4th + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      (f2q()があるとき)
#      int gz4th = VideoController.vcnHidden4th + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#    512ドット256色パレット f1p()
#      k=0  (MainMemory.mmrM8[gy2nd | gx2nd & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st & 1023])
#      k=1  (MainMemory.mmrM8[gy2nd | gx2nd + 2 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 2 & 1023])
#      k=2  (MainMemory.mmrM8[gy2nd | gx2nd + 4 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 4 & 1023])
#      k=3  (MainMemory.mmrM8[gy2nd | gx2nd + 6 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 6 & 1023])
#      k=4  (MainMemory.mmrM8[gy2nd | gx2nd + 8 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 8 & 1023])
#      k=5  (MainMemory.mmrM8[gy2nd | gx2nd + 10 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 10 & 1023])
#      k=6  (MainMemory.mmrM8[gy2nd | gx2nd + 12 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 12 & 1023])
#      k=7  (MainMemory.mmrM8[gy2nd | gx2nd + 14 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 14 & 1023])
#    512ドット256色パレット f2p()
#      k=0  (MainMemory.mmrM8[gy4th | gx4th & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd & 1023])
#      k=1  (MainMemory.mmrM8[gy4th | gx4th + 2 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 2 & 1023])
#      k=2  (MainMemory.mmrM8[gy4th | gx4th + 4 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 4 & 1023])
#      k=3  (MainMemory.mmrM8[gy4th | gx4th + 6 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 6 & 1023])
#      k=4  (MainMemory.mmrM8[gy4th | gx4th + 8 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 8 & 1023])
#      k=5  (MainMemory.mmrM8[gy4th | gx4th + 10 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 10 & 1023])
#      k=6  (MainMemory.mmrM8[gy4th | gx4th + 12 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 12 & 1023])
#      k=7  (MainMemory.mmrM8[gy4th | gx4th + 14 & 1023] << 4 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 14 & 1023])
#    512ドット256色パレット(ONとみなす) f2q()
#      k=0  (MainMemory.mmrM8[gz4th | gx4th & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd & 1023])
#      k=1  (MainMemory.mmrM8[gz4th | gx4th + 2 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 2 & 1023])
#      k=2  (MainMemory.mmrM8[gz4th | gx4th + 4 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 4 & 1023])
#      k=3  (MainMemory.mmrM8[gz4th | gx4th + 6 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 6 & 1023])
#      k=4  (MainMemory.mmrM8[gz4th | gx4th + 8 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 8 & 1023])
#      k=5  (MainMemory.mmrM8[gz4th | gx4th + 10 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 10 & 1023])
#      k=6  (MainMemory.mmrM8[gz4th | gx4th + 12 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 12 & 1023])
#      k=7  (MainMemory.mmrM8[gz4th | gx4th + 14 & 1023] << 4 |
#            MainMemory.mmrM8[gz3rd | gx3rd + 14 & 1023])
#    512ドット256色カラー fpc(p)
#      VideoController.vcnPal16G8[p]
...
#      int pn = VideoController.vcnReg2Curr & 3;  //1番目のパレットのbit3-0のGVRAMページ番号
#      int gx1st = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy1st = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      pn = VideoController.vcnReg2Curr >> 2 & 3;  //1番目のパレットのbit7-4のGVRAMページ番号
#      int gx2nd = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy2nd = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      pn = VideoController.vcnReg2Curr >> 4 & 3;  //1番目のパレットのbit11-8のGVRAMページ番号
#      int gx3rd = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy3rd = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#      pn = VideoController.vcnReg2Curr >> 6 & 3;  //1番目のパレットのbit15-12のGVRAMページ番号
#      int gx4th = CRTC.crtR12GrXCurr[pn] << 1;
#      int gy4th = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);
#    512ドット65536色パレット g1p()
#      k=0  (MainMemory.mmrM8[gy4th | gx4th & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st & 1023])
#      k=1  (MainMemory.mmrM8[gy4th | gx4th + 2 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 2 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 2 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 2 & 1023])
#      k=2  (MainMemory.mmrM8[gy4th | gx4th + 4 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 4 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 4 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 4 & 1023])
#      k=3  (MainMemory.mmrM8[gy4th | gx4th + 6 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 6 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 6 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 6 & 1023])
#      k=4  (MainMemory.mmrM8[gy4th | gx4th + 8 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 8 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 8 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 8 & 1023])
#      k=5  (MainMemory.mmrM8[gy4th | gx4th + 10 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 10 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 10 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 10 & 1023])
#      k=6  (MainMemory.mmrM8[gy4th | gx4th + 12 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 12 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 12 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 12 & 1023])
#      k=7  (MainMemory.mmrM8[gy4th | gx4th + 14 & 1023] << 12 |
#            MainMemory.mmrM8[gy3rd | gx3rd + 14 & 1023] << 8 |
#            MainMemory.mmrM8[gy2nd | gx2nd + 14 & 1023] << 4 |
#            MainMemory.mmrM8[gy1st | gx1st + 14 & 1023])
...
#  H  1024ドット16色
#    1024ドット16色パレット h1p()
#      k=0  MainMemory.mmrM8[ga]
#      k=1  MainMemory.mmrM8[ga + 2]
#      k=2  MainMemory.mmrM8[ga + 4]
#      k=3  MainMemory.mmrM8[ga + 6]
#      k=4  MainMemory.mmrM8[ga + 8]
#      k=5  MainMemory.mmrM8[ga + 10]
#      k=6  MainMemory.mmrM8[ga + 12]
#      k=7  MainMemory.mmrM8[ga + 14]
#    1024ドット16色カラー hpc(p)
#      VideoController.vcnPal16G8[p]
...
#      int gy = CRTC.crtR13GrYCurr[0] + src;  //1024ドット16色y座標。溢れは無視する
#      int ga0 = 0x00c00000 + 1 + ((gy & 511) << 10);  //x=0,y&=511の1024ドット16色アドレス+1
#      int gt = VideoController.vcnReg2Curr >> (gy >> 7 & 4);  //y<512?G2nd|G1st:G4th|G3rd
#      int da = dst << XEiJ.PNL_BM_OFFSET_BITS;  //ARGB出力インデックス
#      int db = da + XEiJ.pnlScreenWidth;  //ARGB出力インデックスの終了位置
#      while (da < db) {
#        int ga = ga0 + ((gt >> (gx >> 8 & 2) & 3) << 19) + ((gx & 511) << 1);  //1024ドット16色アドレス+1
#        int dw = Math.min (db - da, 512 - (gx & 511));  //今回の幅
#        gx += dw;  //次回の1024ドット16色x座標
#        int dc = da + dw - 8;  //今回のARGB出力インデックスの終了位置-8
#        while (da <= dc) {
#          (ローカル変数宣言)
#          XEiJ.pnlBM[da] = (k=0のARGB);
#          XEiJ.pnlBM[da + 1] = (k=1のARGB);
...
#  I  1024ドット256色
#    1024ドット256色パレット i1p()
#      k=0  (MainMemory.mmrM8[ga] & 255)
#      k=1  (MainMemory.mmrM8[ga + 2] & 255)
#      k=2  (MainMemory.mmrM8[ga + 4] & 255)
#      k=3  (MainMemory.mmrM8[ga + 6] & 255)
#      k=4  (MainMemory.mmrM8[ga + 8] & 255)
#      k=5  (MainMemory.mmrM8[ga + 10] & 255)
#      k=6  (MainMemory.mmrM8[ga + 12] & 255)
#      k=7  (MainMemory.mmrM8[ga + 14] & 255)
#    1024ドット256色カラー ipc(p)
#      VideoController.vcnPal16G8[p]
#    1024ドット256色ARGB ipo(p)
#      VideoController.vcnPal32G8[p]
#    1024ドット256色構造
#      1024ドット16色構造の以下の部分を変更する
#      int ga0 = 0x00c00000 + 1 + ((gy & 511) << 10);  //x=0,y&=511の1024ドット16色アドレス+1
#        ↓
#      int ga0 = XEiJ.BUS_MODIFIED_256_PAGE + 1 + ((gy & 511) << 10);  //x=0,y&=511の1024ドット256色アドレス+1
#
#  J  1024ドット65536色
#    1024ドット65536色パレット j1p()
#      k=0  (char) (MainMemory.mmrM8[ga] << 8 |
#                   MainMemory.mmrM8[ga + 1] & 255)
#      k=1  (char) (MainMemory.mmrM8[ga + 2] << 8 |
#                   MainMemory.mmrM8[ga + 3] & 255)
#      k=2  (char) (MainMemory.mmrM8[ga + 4] << 8 |
#                   MainMemory.mmrM8[ga + 5] & 255)
#      k=3  (char) (MainMemory.mmrM8[ga + 6] << 8 |
#                   MainMemory.mmrM8[ga + 7] & 255)
#      k=4  (char) (MainMemory.mmrM8[ga + 8] << 8 |
#                   MainMemory.mmrM8[ga + 9] & 255)
#      k=5  (char) (MainMemory.mmrM8[ga + 10] << 8 |
#                   MainMemory.mmrM8[ga + 11] & 255)
#      k=6  (char) (MainMemory.mmrM8[ga + 12] << 8 |
#                   MainMemory.mmrM8[ga + 13] & 255)
#      k=7  (char) (MainMemory.mmrM8[ga + 14] << 8 |
#                   MainMemory.mmrM8[ga + 15] & 255)
...
#      int ga0 = 0x00c00000 + 1 + ((gy & 511) << 10);  //x=0,y&=511の1024ドット16色アドレス+1
#        ↓
#      int ga0 = XEiJ.BUS_MODIFIED_65536_PAGE + ((gy & 511) << 10);  //x=0,y&=511の1024ドット65536色アドレス
#
...
sub generate {
  ...
  my $mode = {
    ...
    toeven => 0,  #1=グラフィックスパレットを偶数化する。even1st..4thのときそれぞれ1..4番目のパレットは偶数化する必要がない
    toodd => 0,  #1=グラフィックスパレットを奇数化する。odd1st..4thのときそれぞれ1..4番目のパレットは奇数化する必要がない
    xword => $xword,  #拡張ワード
    encode => 0  #0=手順,1=コード
    };
  #
  ...
  if ($keyword =~ /E/) {
    if ($status->{'id_e1p'}) {
      ...
      push @preparation, "int gx1st = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy1st = VideoController.vcnVisible1st + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @update1, "gx1st += 2;\n";
      push @update8, "gx1st += 16;\n";
    }
    if ($status->{'id_e2p'} || $status->{'id_e2q'}) {
      push @preparation, "pn = VideoController.vcnReg2Curr >> 2 & 3;  //2番目のパレットのGVRAMページ番号\n";
      push @preparation, "int gx2nd = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @update1, "gx2nd += 2;\n";
      push @update8, "gx2nd += 16;\n";
    }
    if ($status->{'id_e2p'}) {
      push @preparation, "int gy2nd = VideoController.vcnVisible2nd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
    }
    if ($status->{'id_e2q'}) {
      push @preparation, "int gz2nd = VideoController.vcnHidden2nd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);  //ONとみなす\n";
    }
    if ($status->{'id_e3p'}) {
      push @preparation, "pn = VideoController.vcnReg2Curr >> 4 & 3;  //3番目のパレットのGVRAMページ番号\n";
      push @preparation, "int gx3rd = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy3rd = VideoController.vcnVisible3rd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @update1, "gx3rd += 2;\n";
      push @update8, "gx3rd += 16;\n";
    }
    if ($status->{'id_e4p'}) {
      push @preparation, "pn = VideoController.vcnReg2Curr >> 6 & 3;  //4番目のパレットのGVRAMページ番号\n";
      push @preparation, "int gx4th = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy4th = VideoController.vcnVisible4th + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @update1, "gx4th += 2;\n";
      push @update8, "gx4th += 16;\n";
    }
  }
  #512ドット256色
  if ($keyword =~ /F/) {
    ...
    if ($status->{'id_f2q'}) {
      push @preparation, "int gz3rd = VideoController.vcnHidden3rd + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
    }
    if ($status->{'id_f2p'} || $status->{'id_f2q'}) {
    ...
    if ($status->{'id_f2q'}) {
      push @preparation, "int gz4th = VideoController.vcnHidden4th + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
    }
    if ($status->{'id_f1p'}) {
      push @update1, "gx1st += 2;\n";
      push @update1, "gx2nd += 2;\n";
  ...
  if ($keyword =~ /G/) {
    if ($status->{'id_g1p'}) {
      push @preparation, "int pn = VideoController.vcnReg2Curr & 3;  //1番目のパレットのbit3-0のGVRAMページ番号\n";
      push @preparation, "int gx1st = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy1st = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @preparation, "pn = VideoController.vcnReg2Curr >> 2 & 3;  //1番目のパレットのbit7-4のGVRAMページ番号\n";
      push @preparation, "int gx2nd = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy2nd = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @preparation, "pn = VideoController.vcnReg2Curr >> 4 & 3;  //1番目のパレットのbit11-8のGVRAMページ番号\n";
      push @preparation, "int gx3rd = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy3rd = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @preparation, "pn = VideoController.vcnReg2Curr >> 6 & 3;  //1番目のパレットのbit15-12のGVRAMページ番号\n";
      push @preparation, "int gx4th = CRTC.crtR12GrXCurr[pn] << 1;\n";
      push @preparation, "int gy4th = 0x00c00000 + 1 + (pn << 19) + ((CRTC.crtR13GrYCurr[pn] + src & 511) << 10);\n";
      push @update1, "gx1st += 2;\n";
      push @update1, "gx2nd += 2;\n";
      push @update1, "gx3rd += 2;\n";
      push @update1, "gx4th += 2;\n";
  ...
  #構造
  push @body, "  $xkeyword {\n";
  push @body, "    \@Override public void drawRaster (int src, int dst) {\n";
  if ($keyword !~ /[Tt]/ && $keyword !~ /[HIJ]/) {  #テキストがなくて1024ドットもない
    ...
    push @body, map { "      $_" } @preparation;  #準備
    push @body, "      int tc = CRTC.crtR10TxXCurr >> 3;  //テキスト桁位置\n";
    push @body, "      int ta0 = 0x00e00000 + ((CRTC.crtR11TxYCurr + src & 1023) << 7);  //桁0のテキストアドレス\n";
    ...
    push @body, "          tc = tc + 1 & 127;  //次回のテキスト桁位置\n";
    push @body, map { "          $_" } @localvariable;  #ローカル変数宣言
    push @body, map { "          $_" } @{$draw[0]};
    push @body, map { "          $_" } @{$draw[1]};
    push @body, map { "          $_" } @{$draw[2]};
    ...
    push @body, "      int gy = CRTC.crtR13GrYCurr[0] + src;  //1024ドットy座標。溢れは無視する\n";
    if ($keyword =~ /H/) {
      push @body, "      int ga0 = 0x00c00000 + 1 + ((gy & 511) << 10);  //x=0,y&=511の1024ドットアドレス+1\n";
    } elsif ($keyword =~ /I/) {
      push @body, "      int ga0 = XEiJ.BUS_MODIFIED_256_PAGE + 1 + ((gy & 511) << 10);  //x=0,y&=511の1024ドットアドレス+1\n";
    } elsif ($keyword =~ /J/) {
      push @body, "      int ga0 = XEiJ.BUS_MODIFIED_65536_PAGE + ((gy & 511) << 10);  //x=0,y&=511の1024ドットアドレス\n";
    } else {
      die;
    }
    ...
    push @body, "      int db = da + XEiJ.pnlScreenWidth;  //ARGB出力インデックスの終了位置\n";
    push @body, "      while (da < db) {\n";
    push @body, "        int ga = ga0 + ((gt >> (gx >> 8 & 2) & 3) << 19) + ((gx & 511) << 1);  //1024ドットアドレス+1\n";
    push @body, "        int dw = Math.min (db - da, 512 - (gx & 511));  //今回の幅\n";
    push @body, "        gx += dw;  //次回の1024ドットx座標\n";
    push @body, "        int dc = da + dw - 8;  //今回のARGB出力インデックスの終了位置-8\n";
    ...
    push @body, "                      VideoController.VCN_TXP1[MainMemory.mmrM8[ta1 + tc] & 255] |\n";
    push @body, "                      VideoController.VCN_TXP0[MainMemory.mmrM8[ta0 + tc] & 255]);\n";
    push @body, "            ts = dc - da;  //次回のテキスト桁境界からのずれ\n";
    push @body, "            do {\n";
    push @body, map { "              $_" } @localvariable;  #ローカル変数宣言
    push @body, map { "              $_" } @{$draw[0]};
    push @body, map { "              $_" } @update1;  #更新1
    ...
    push @body, "                      VideoController.VCN_TXP0[p0 >>> 24]);  //符号なし右シフトで&255を省略\n";
    push @body, "            tc = tc + 1 & 127;  //次回のテキスト桁位置\n";
    push @body, "            ts = ts + dc - da & 7;  //次回のテキスト桁境界からのずれ\n";
    push @body, "            do {\n";
    push @body, map { "              $_" } @localvariable;  #ローカル変数宣言
    push @body, map { "              $_" } @{$draw[0]};
    push @body, map { "              $_" } @update1;  #更新1
...
sub main {
  ...
  for (my $i = 0; $i <= $#KEYWORD; $i++) {
    ...
    my $gonly = $keyword =~ /^(?:E1|E2|E3|E4|F1|F2|G|H|I|J)t?$/ ? $& : '';  #グラフィックスのみ
    my $g1plus = $keyword =~ /(?:E1|E2|E3|E4|F1|F2|G|H|I|J)/ ? $& : '';  #グラフィックスが1プレーン以上ある
    my $g2plus = $keyword =~ /(?:E1|E2|E3|E4|F1|F2)/ ? $& : '';  #グラフィックスが2プレーン以上ある
    my @one_keyword_list = ();
    {
      my $xword = '';
    ...
    {
      my $xword = 'XWC';
      if ($gonly) {  #特殊プライオリティでグラフィックスのみ。パレットは変わらないので無効
        push @one_keyword_list, $keyword, $xword, $keyword, '';  #拡張なしに変更
      } elsif ($g1plus) {  #特殊プライオリティでグラフィックスとスプライトまたはテキストがある。グラフィックスが手前でも奥に見えていたスプライトまたはテキストが見えなくなるので有効
        push @ax_body, generate ($keyword, $xword);
        push @one_keyword_list, $keyword, $xword, $keyword, $xword;
      } else {  #特殊プライオリティでグラフィックスがない
        push @one_keyword_list, $keyword, $xword, $keyword, '';  #拡張なしに変更
      }
    }
    {
      my $xword = 'XWP';
      if ($g1plus) {  #特殊プライオリティでグラフィックスがある。パレットが偶数化されるのでグラフィックスのみでも有効
        push @ax_body, generate ($keyword, $xword);
        push @one_keyword_list, $keyword, $xword, $keyword, $xword;
      } else {  #特殊プライオリティでグラフィックスがない
        push @one_keyword_list, $keyword, $xword, $keyword, '';  #拡張なしに変更
    ...
    {
      my $xword = 'XHCT';
      if ($g1plus) {  #2番目を使わない半透明でグラフィックスがある
        push @ax_body, generate ($keyword, $xword);
        push @one_keyword_list, $keyword, $xword, $keyword, $xword;
      } else {  #半透明でグラフィックスがない
        push @one_keyword_list, $keyword, $xword, $keyword, '';  #拡張なしに変更
    ...
    {
      my $xword = 'A';
      if ($gonly) {  #テキストパレット0と半透明でグラフィックスのみ
        push @ax_body, generate ($keyword, $xword);
        push @one_keyword_list, $keyword, $xword, $keyword, $xword;
      } elsif ($g1plus) {  #テキストパレット0と半透明でグラフィックスとスプライトまたはテキストがある
        push @one_keyword_list, $keyword, $xword, $g1plus, 'A';  #グラフィックスのみに変更
      } else {  #テキストパレット0と半透明でグラフィックスがない
    ...
    push @all_keyword_body, "  X$keyword {\n";
    push @all_keyword_body, "    \@Override public void drawRaster (int src, int dst) {\n";
    if (@one_keyword_list) {
      ...
      while (@one_keyword_list) {
        ...
        push @all_keyword_body, "        $xkeyword2.drawRaster (src, dst);\n";
        push @all_keyword_body, "        break;\n";
      }
      push @all_keyword_body, "      default:\n";
      push @all_keyword_body, "        $keyword.drawRaster (src, dst);\n";
    ...
    push @all_keyword_body, "    }  //drawRaster(int,int)\n";
    push @all_keyword_body, "  },  //X$keyword\n";
  ...
  print OUT $all;
  print OUT "\n";
  print OUT "  public abstract void drawRaster (int src, int dst);\n";
  print OUT "\n";
